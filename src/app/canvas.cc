...
void Canvas::putPixel(int x, int y, float z, const Color &color)
{
...
void Canvas::drawPoint(const Vector &position, const Color &color)
{
...
void Canvas::drawScanline(const Vertex &v1, const Vertex &v2, int y, const Texture *texture)
{
...
void Canvas::drawTriangle(const Vertex &v1, const Vertex &v2, const Vertex &v3, const Texture *texture)
{
...
void Canvas::drawMesh(const Mesh &mesh)
{
    ...
    static auto projection = Matrix::perspectiveFovLH(degrees2radians(45), _width / _height, 0.1, 1);
